% blinkingfit_0123_dataset6.m
%
% Note that unlike the others, I did not renormalize this dataset.
%
% Nathanael Kazmierczak, 01/29/2020

filename = '6_50x50_ss=2nm_C2=40um_alpha=1mrad_spot7_200ms_CL=130 bin=4_60kV.h5';
cd ..
addpath(genpath(pwd));
cd DSC_BlinkingFit_Code
addpath('/Volumes/NPKResearch/BediakoLab/Maddie4DSTEM/20200123');
results_path = '/Users/nathanaelkazmierczak/Dropbox/NPKHardDriveBackupFall2017/workspace/BediakoResearch/NPK_MatlabDataGeneral/DSC_BlinkingFit/Results/0123_dataset6';
