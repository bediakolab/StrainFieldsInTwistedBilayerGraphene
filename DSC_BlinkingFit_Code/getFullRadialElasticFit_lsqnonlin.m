function [residuals] = getFullRadialElasticFit_lsqnonlin(c,fitdata,function_string,const_vals)
...
residuals = predmat - fitdata;
residuals(fitdata == -1) = [];  % because -1 was the signal that this point should be excluded.
