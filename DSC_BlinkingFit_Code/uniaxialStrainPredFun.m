function [ moire_wavelengths ] = uniaxialStrainPredFun( theta_moire, theta_strain, epsilon_strain_percent )
% Fitting function for computing uniaxial heterostrain of a twisted bilayer
% graphene sample.
%
% Follows the Kerelsky et al model. (2019 Columbia STM)
% 
% Nathanael Kazmierczak, 05/27/2020
