...
end  % Added by NPK 04/11/2020 to try to get the local function recognized.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% H11p auxiliary function
% Refactored out of local function for tvqc in order to get it to work on
% Maddie's computer, by NPK on 04/11/2020.
%
