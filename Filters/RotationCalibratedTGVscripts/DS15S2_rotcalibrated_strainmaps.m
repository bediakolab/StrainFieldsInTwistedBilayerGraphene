% DS15S2_rotcalibrated_strainmaps.m
%
...
if ~exist('m4','var')
    ...
    load('06222020_DS15S2_annealed.mat');
    ...
    m4.saved_plots_foldername = 'DS15S2';
end
...
m4.saved_plots_foldername = 'DS15S2_nanoparticle_calibration_SP1';
TGVid = 'DS15S2';  % versus Colin's original parameter settings.
...
if true
    ...
    close all
    m4.saved_plots_foldername = 'DS15S2_nanoparticle_calibration_SP2';
    rotational_calib_method = 'nanoparticle mod';
    ...
    m4.saved_plots_foldername = 'DS15S2_nanoparticle_calibration_SP3';
    rotational_calib_method = 'nanoparticle mod';
...
if true   % will return to this for other datasets, but 8S2 is already computed.
    ...
    m4.saved_plots_foldername = 'DS15S2_nodividebytwo';
    colormaptype = {cmap,cmap};  % option to have one colormap for principal strain.
