% DS1S2_rotcalibrated_strainmaps.m
%
...
if ~exist('m4','var')
    ...
    load('06222020_DS1S2_annealed.mat');
...
m4.saved_plots_foldername = 'DS1S2_nanoparticle_calibration_SP1';
TGVid = 'DS1S2';  % versus Colin's original parameter settings.
...
if false
    ...
    close all
    m4.saved_plots_foldername = 'DS3S2_nanoparticle_calibration_SP2';
    TGVid = 'DS3S2';  % Just to see what it will look like
    rotational_calib_method = 'nanoparticle mod';
    ...
    m4.saved_plots_foldername = 'DS3S2_nanoparticle_calibration_SP3';
    TGVid = 'DS3S2';  % Just to see what it will look like
    rotational_calib_method = 'nanoparticle mod';
...
if true   % will return to this for other datasets, but 8S2 is already computed.
    tensor_rotate_SPid = 1;
    m4.saved_plots_foldername = 'DS1S2';
    TGVid = 'DS1S2';  % versus Colin's original parameter settings.
...
if false
    ...
    m4.saved_plots_foldername = 'DS3S2_nodividebytwo';
    TGVid = 'DS3S2';  % versus Colin's original parameter settings.
    colormaptype = {cmap,cmap};  % option to have one colormap for principal strain.
