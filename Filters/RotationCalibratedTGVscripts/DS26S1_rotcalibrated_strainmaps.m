% DS26S1_rotcalibrated_strainmaps.m
%
% Strain map function built for Session 1 data. Strain
% mapping and annealing are now found in separate functions. This script
% applies the Session 2 calibration to Session 1 data to see what happens.
%
...
if ~exist('m4','var')
    ...
    m4.saved_plots_foldername = 'DS26';
end
...
m4.saved_plots_foldername = 'DS26noprefactor_nanoparticle_calibration_SP1';
...
% m4.saved_plots_foldername = 'DS12S2_nanoparticle_calibration_DS26heavyfilter_SP1';
...
if true
    close all
%     m4.saved_plots_foldername = 'DS12S2_nanoparticle_calibration_DS26heavyfilter_SP2';
%     TGVid = heavyTGVid;  % Just to see what it will look like
%     rotational_calib_method = 'nanoparticle mod';
...
%     
%     
%     m4.saved_plots_foldername = 'DS12S2_nanoparticle_calibration_DS26heavyfilter_SP3';
%     TGVid = heavyTGVid;  % Just to see what it will look like
%     rotational_calib_method = 'nanoparticle mod';
...
%     m4.plotStrainMaps3(saveplotflag,overlay_registration,colormaptype);
    ...
    close all
    m4.saved_plots_foldername = 'DS26noprefactor_nanoparticle_calibration_SP2';
    TGVid = lightTGVid;  
    rotational_calib_method = 'nanoparticle mod';
    tensor_rotate_SPid = 2;  % after setting the x-axis via rotational calibration, rotate to tensor.
    colormaptype = {cmap,fire};  % option to have one colormap for principal strain.
    ...
    m4.saved_plots_foldername = 'DS26noprefactor_nanoparticle_calibration_SP3';
    TGVid = lightTGVid;
    rotational_calib_method = 'nanoparticle mod';
    tensor_rotate_SPid = 3;  % after setting the x-axis via rotational calibration, rotate to tensor.
    colormaptype = {cmap,fire};  % option to have one colormap for principal strain.
