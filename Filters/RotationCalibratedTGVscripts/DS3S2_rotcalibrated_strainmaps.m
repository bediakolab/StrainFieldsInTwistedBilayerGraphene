% DS3S2_rotcalibrated_strainmaps.m
%
...
if ~exist('m4','var')
    ...
    load('06222020_DS3S2_annealed.mat');
    ...
    m4.saved_plots_foldername = 'DS3S2';
end
...
m4.saved_plots_foldername = 'DS3S2_nanoparticle_calibration_SP1';
