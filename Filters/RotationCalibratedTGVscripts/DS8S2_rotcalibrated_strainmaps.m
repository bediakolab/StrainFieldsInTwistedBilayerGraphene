% DS8S2_rotcalibrated_strainmaps.m
%
...
m4.scan_direction_theta_deg = 270;
...
m4.saved_plots_foldername = 'DS8S2_nanoparticle_calibration_SP1';
...
m4.saved_plots_foldername = 'DS8S2_nanoparticle_calibration_DS26heavyfilter_SP1';
TGVid = 'DS26';  % Just to see what it will look like
rotational_calib_method = 'nanoparticle mod';
...
if true
    close all
    m4.saved_plots_foldername = 'DS8S2_nanoparticle_calibration_DS26heavyfilter_SP2';
    TGVid = 'DS26';  % Just to see what it will look like
    rotational_calib_method = 'nanoparticle mod';
    ...
    m4.saved_plots_foldername = 'DS8S2_nanoparticle_calibration_DS26heavyfilter_SP3';
    TGVid = 'DS26';  % Just to see what it will look like
    rotational_calib_method = 'nanoparticle mod';
    ...
    close all
    m4.saved_plots_foldername = 'DS8S2_nanoparticle_calibration_SP2';
    TGVid = 'DS8S2';  % Just to see what it will look like
    rotational_calib_method = 'nanoparticle mod';
    tensor_rotate_SPid = 2;  % after setting the x-axis via rotational calibration, rotate to tensor.
    colormaptype = {cmap,fire};  % option to have one colormap for principal strain.
    divide_by_two_for_intralayer = true;
    ...
    m4.saved_plots_foldername = 'DS8S2_nanoparticle_calibration_SP3';
    TGVid = 'DS8S2';  % Just to see what it will look like
    rotational_calib_method = 'nanoparticle mod';
    tensor_rotate_SPid = 3;  % after setting the x-axis via rotational calibration, rotate to tensor.
    colormaptype = {cmap,fire};  % option to have one colormap for principal strain.
