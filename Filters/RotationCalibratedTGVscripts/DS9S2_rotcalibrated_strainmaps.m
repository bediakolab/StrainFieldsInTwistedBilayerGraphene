% DS9S2_rotcalibrated_strainmaps.m
%
...
if ~exist('m4','var')
    ...
    load('06222020_DS9S2_annealed.mat');
...
m4.saved_plots_foldername = 'DS9S2_nanoparticle_calibration_SP1';
...
m4.saved_plots_foldername = 'DS9S2_nanoparticle_calibration_DS26heavyfilter_SP1';
...
if true
    close all
    m4.saved_plots_foldername = 'DS9S2_nanoparticle_calibration_DS26heavyfilter_SP2';
    TGVid = heavyTGVid;  % Just to see what it will look like
    rotational_calib_method = 'nanoparticle mod';
    ...
    m4.saved_plots_foldername = 'DS9S2_nanoparticle_calibration_DS26heavyfilter_SP3';
    TGVid = heavyTGVid;  % Just to see what it will look like
    rotational_calib_method = 'nanoparticle mod';
    ...
    close all
    m4.saved_plots_foldername = 'DS9S2_nanoparticle_calibration_SP2';
    TGVid = lightTGVid;  
    rotational_calib_method = 'nanoparticle mod';
    tensor_rotate_SPid = 2;  % after setting the x-axis via rotational calibration, rotate to tensor.
    colormaptype = {cmap,fire};  % option to have one colormap for principal strain.
    ...
    m4.saved_plots_foldername = 'DS9S2_nanoparticle_calibration_SP3';
    TGVid = lightTGVid;
    rotational_calib_method = 'nanoparticle mod';
    tensor_rotate_SPid = 3;  % after setting the x-axis via rotational calibration, rotate to tensor.
    colormaptype = {cmap,fire};  % option to have one colormap for principal strain.
