% DS30S2_TGV_strainmaps.m
%
% First of the strain map functions built for Session 2 data. Strain
...
%     load('05312020_chiralfixed_DS8_postannealing.mat');
    ...
    m4.saved_plots_foldername = 'DS30S2';
end
...
TGVid = 'DS30S2';  % versus Colin's original parameter settings.
SPdirection = 1;
