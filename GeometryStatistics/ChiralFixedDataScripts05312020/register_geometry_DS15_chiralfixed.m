% register_geometry_chiralfixed_DS15.m
%
% Because registration of this dataset depends sensitively on the filter
% immunity mask, we will load the one from the previous geometry
% registration and flip it on the y axis.
%
...
if ~exist('m4','var')
    addpath('/Users/nathanaelkazmierczak/Dropbox/NPKHardDriveBackupFall2017/workspace/BediakoResearch/NPK_MatlabDataGeneral/TEAM1Data/withPrefactorFit/Dataset15');
    load('DS15objectdata.mat');
end
m4.scan_stepsize = 1;
m4.reformAxes();
...
gaussian_filter_threshold = 0.09;
