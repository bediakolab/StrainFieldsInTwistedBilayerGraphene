% register_geometry_DS18.m
%
% Similar to DS15, load immunity mask from previous geometry registration.
...
load('05232020_DS18_GeometryFit_PreparedForAnnealing.mat');
filter_im_mask = flipud(m4.filter_immunity_mask);
clearvars -except filter_im_mask

if ~exist('m4','var')
    addpath('/Users/nathanaelkazmierczak/Dropbox/NPKHardDriveBackupFall2017/workspace/BediakoResearch/NPK_MatlabDataGeneral/TEAM1Data/withPrefactorFit/Dataset18');
    load('DS18objectdata.mat');
end
m4.scan_stepsize = 1;
m4.reformAxes();
...
gaussian_filter_threshold = 0.06;
...
[average_angle,std_angle,max_angle,min_angle,n_triangles_used] = m4.plotFacetedTwistAngles([0.12,0.16])
