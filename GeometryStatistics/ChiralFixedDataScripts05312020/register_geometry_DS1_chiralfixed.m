% register_geometry_DS1_chiralfixed.m
%
...
addpath('/Users/nathanaelkazmierczak/Dropbox/NPKHardDriveBackupFall2017/workspace/BediakoResearch/NPK_MatlabDataGeneral/TEAM1Data/withPrefactorFit/Dataset1');
load('DS1objectdata.mat');
m4.scan_stepsize = 1;  % These are big unit cells.
m4.reformAxes();
...
%     m4.filter_immunity_mask = filter_im_mask;
% end
...
optional_AAcircle_min_radius = 2;  % in pixels.
...
[average_angle,std_angle,max_angle,min_angle] = m4.plotFacetedTwistAngles([0.5,inf],parula,true);
m4.repairTriangulation();
m4.fitUniaxialStrain([],0.2);
[average_angle,std_angle,max_angle,min_angle] = m4.plotFacetedTwistAngles([],parula,true,true)
m4.plotFacetedUniaxialStrain();
[av_moire_angle,std_moire_angle,min_moire_angle,max_moire_angle,...
                ...
                m4.getUniaxialStrainStatistics(true,[],[],[])
