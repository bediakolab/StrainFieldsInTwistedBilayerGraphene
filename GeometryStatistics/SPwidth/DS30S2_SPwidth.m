...
if ~exist('m4','var')
    ...
    load('06222020_DS30S2_annealed.mat');
end
...
cutoff_score = 0.5;
[distcoords,av_scores,distance,endpoint1,endpoint2] = m4.getSPwidths(filterstruct,cut_number,cut_spacing_nm,AA_center_type,radius_value,image_boundary_buffer,pixel_size_cutoff,window_dims_nm,cutoff_score)
