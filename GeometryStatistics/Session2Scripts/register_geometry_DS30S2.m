% register_geometry_DS30S2.m
%
% This script is the first of the geometry registration scripts for the
% Session 2 data. 
%
% Nathanael Kazmierczak, 06/01/2020

addpath('/Users/nathanaelkazmierczak/Dropbox/NPKHardDriveBackupFall2017/workspace/BediakoResearch/NPK_MatlabDataGeneral/TEAM1Data/withPrefactorFit/Session2/DS30S2');
load('DS30S2objectdata.mat');
...
m4.triangulateAA(1);  % Using circle fit because of the rather odd nature of DS30S2.
m4.setFacetTwistAngles();
m4.repairTriangulation();
[average_angle,std_angle,max_angle,min_angle] = m4.plotFacetedTwistAngles([0,inf]);
