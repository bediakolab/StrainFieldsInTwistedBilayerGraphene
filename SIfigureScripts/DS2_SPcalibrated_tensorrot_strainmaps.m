% DS2_SPcalibrated_tensorrot_strainmaps.m
%
...
if ~exist('m4','var')
    ...
    m4.saved_plots_foldername = 'DS2_SP1tensorrot';
end
...
if true
    ...
    close all
    m4.saved_plots_foldername = 'DS2_SP2tensorrot';
    ...
    m4.saved_plots_foldername = 'DS2_SP3tensorrot';
