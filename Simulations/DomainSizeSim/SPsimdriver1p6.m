...
gaussian_filter_threshold = 0.01;
AAblur_Gaussian_sigma = 3;
...
% % setup
% 
boundary_inflation_margin = 5;  % For getting AB area, don't want this.
boundary_trim_margin = 5;  % For doing the small stepsizes
...
radius_value = 3;
image_boundary_buffer = 15;  % pixels
pixel_size_cutoff = 0;
window_dims_nm = [3,4];  % First value is for the width, second for the length
cutoff_score = 0.5;
