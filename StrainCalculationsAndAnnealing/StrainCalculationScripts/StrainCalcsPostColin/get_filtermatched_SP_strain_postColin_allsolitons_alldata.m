% get_filtermatched_SP_strain_postColin_soliton2.m
%
...
TGVids = {'DS2','DS4','DS5','DS8','DS10','DS15','DS18','DS26','DS30S2','DS8S2','DS8S2','DS8S2','DS8S2','DS8S2','DS8S2','DS8S2','DS8S2','DS8S2'};
flip_signs = [];
...
%     useStrainFilterMatchedSP = 0;
    ...
    [values,stds,npixels,names,stderrs,nconn] = m4.getStrainInSPBufferMask(SOLITON_DIRECTION,SPbufferdist,...
