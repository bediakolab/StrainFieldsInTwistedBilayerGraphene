% get_filtermatched_SP_strain_postColin_allsolitons_originaldata.m
%
...
figure
errorbar(twist_angle_data,2*fixed_body_rotation_avs',2*2*fixed_body_rotation_stderrs',2*2*fixed_body_rotation_stderrs',xneg,xpos,'o');
